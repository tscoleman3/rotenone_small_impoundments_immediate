...
xc = x + 0.03
xt = x - 0.03
png("lmb_mla0_log.png", h = 7 * ppi, w = 4 * ppi, res = ppi)
par(mfrow = c(2,1), mar = c(0.5,1,0.5,1), oma = c(1.5,3,0.5,0), cex.axis = 1, cex.lab = 1.2, mgp = c(1,0.75,0))
plot(x = 1, y = 1, type = "n", xlab = "", ylab = "", xlim = c(0.75,2.25), ylim = c(3,4.6),las = 1, xaxt = "n")   
...
mtext(side = 2, outer = T, "ln Age-0 LMB Mean TL (mm)", line = 1.2, cex = 1.2)                                               
