...
plot(1,1, type = "n", xlim = c(2017,2019) + range(c(off_c1, off_c2, off_t1, off_t2)), ylim = range(seq(0,90,10)) * c(1, 1.15),
     xaxt = "n", las = 1, ylab = "")
...
mtext(side = 2, outer = T, "LMB Proportional Size Distribution (PSD)", line = 1.75, cex = 1.2) 
dev.off()
