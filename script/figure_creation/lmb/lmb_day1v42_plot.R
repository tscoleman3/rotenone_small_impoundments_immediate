...
xc = x + 0.03
xt = x - 0.03
png("lmb_day1-42-18.png", h = 7 * ppi, w = 4 * ppi, res = ppi)
...
plot(x = 1, y = 1, type = "n", xlab = "", ylab = "", xlim = c(0.75,2.25), ylim = range(0,250),las = 1, xaxt = "n")     
usr = par("usr"); xdiff = usr[2] - usr[1]; ydiff = usr[4] - usr[3]
...
mtext(side = 2, outer = T, "Total LMB Catch Per Impoundment", line = 1.75, cex = 1.2)                                                       
